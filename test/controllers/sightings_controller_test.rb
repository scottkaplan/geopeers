...
class SightingsControllerTest < ActionController::TestCase
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post :create, sighting: { device_id: @sighting.device_id, gps_latitude: @sighting.gps_latitude, gps_longitude: @sighting.gps_longitude }
    end
  ...
  test "should update sighting" do
    patch :update, id: @sighting, sighting: { device_id: @sighting.device_id, gps_latitude: @sighting.gps_latitude, gps_longitude: @sighting.gps_longitude }
    assert_redirected_to sighting_path(assigns(:sighting))
  end
