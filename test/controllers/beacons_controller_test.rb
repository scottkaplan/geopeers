...
class BeaconsControllerTest < ActionController::TestCase
  ...
  test "should create beacon" do
    assert_difference('Beacon.count') do
      post :create, beacon: { beacon: @beacon.beacon, expire_time: @beacon.expire_time, seen_device_id: @beacon.seen_device_id, seer_device_id: @beacon.seer_device_id }
    end
  ...
  test "should update beacon" do
    patch :update, id: @beacon, beacon: { beacon: @beacon.beacon, expire_time: @beacon.expire_time, seen_device_id: @beacon.seen_device_id, seer_device_id: @beacon.seer_device_id }
    assert_redirected_to beacon_path(assigns(:beacon))
  end
